...
const Tab_2 = (props) => {
  ...
  setValue(
    "total",
    Number(props.form_val_1.price) * Number(props.form_val_1.quantity) +
      Number(props.dc) +
      " " +
  ...
  useEffect(() => {
    ...
    if (bankDetails !== 0 && bankDetails?.data?.[0]) {
  ...
  async function loadDetails() {
    try {
      const response = await fetch(
        "https://myzabiha.com/web_app/public/api/getBankAccounts"
      );
      const details = await response.json();
      await setBankDetails(details);
    } catch (error) {
      alert(
        "Sorry for the inconvenience, We Are facing some issues from Server"
      );
    }
  }
            ...
            <div className="row tab-2">
              <div className="col-7">
                ...
                {props.showDelivery ? (
                  <>
                    <div className={"row alive-slotter showDelivery"}>
                      ...
                      <select
                        {...register("slotter_Alive")}
                        onChange={() => {
                          countryDrop();
                        }}
                      >
                        <option>Select Slaughtered or Alive</option>
                        <option value="Slotter">Slaughtered</option>
                ...
                <div className="row if-not">
                  <p>
                    If the product/quantity is not available Add multiple choice
                    option
                  </p>
                  <select {...register("if_not")}>
                    <option value={"Remove it from my order"}>
                ...
                <div className="row move">
                  <div className="col-5">
                    <button className="back" onClick={props.backBtn}>
                      Back
                    </button>
                  </div>
                  <div className="col-7">
              ...
              <div className="col-5">
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="data">
                        {props.form_val_1.distribute_or_delivery}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="data">
                        <input
                          ...
                          value={props.form_val_1.price}
                        />
                        {props.form_val_1.price +
                          " " +
                          localStorage.getItem("currency")}
                      </td>
                    </tr>
                ...
                <div style={{ marginTop: "30px", textAlign: "center" }}>
                  ...
                  <div className="amount">
                    ...
                    {Number(props.form_val_1.price) *
                      Number(props.form_val_1.quantity) +
                      Number(props.dc) +
                      " " +
                      localStorage.getItem("currency")}
                  </div>
